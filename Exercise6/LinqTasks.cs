...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<object> result = Depts.GroupJoin(Emps, dept => dept.Deptno, emp => emp.Deptno
                , (dept, emps) => new
                {
                    name = dept.Dname,
        ...
        {
            IEnumerable<Emp> result = CustomExtensionMethods.GetBosses();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                ...
                .Where((dept) => dept.numOfEmployees == 5 || dept.numOfEmployees==0)
    ...
    {
        public static IEnumerable<Emp> GetBosses()
        {
            var result = LinqTasks.Emps
                .GroupJoin(
                    LinqTasks.Emps,
                    emp => emp.Empno,
                    emp1 => emp1.Mgr == null ? -1 : emp1.Mgr.Empno,
                    (emp, emp1) => new
                    {
                        Manager = emp,
                        numOfEmployees = emp1.Count()
                    })
